    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-black px-4">
      <div className="w-full max-w-sm space-y-8 text-center">
        <div className="space-y-2">
          ...
          <p className="text-zinc-400 text-sm">Quincy House, Harvard University</p>
        </div>

        <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-6 space-y-4">
          <p className="text-zinc-300 text-sm">
            Sign in with your Harvard Google account to join the game.
          </p>
          <form
            action={async () => {
              'use server'
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 text-sm font-semibold text-black hover:bg-zinc-100 transition-colors"
            >
